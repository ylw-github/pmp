package com.ylw.log.service.impl;

import com.ylw.log.model.Audit;
import com.ylw.log.service.IAuditService;
 ...
 *
 * @author : YangLinWei
 * @createTime: 2021/6/10 5:43 下午
 */
@Slf4j
@ConditionalOnProperty(name = "ylw.audit-log.log-type", havingValue = "logger", matchIfMissing = true)
